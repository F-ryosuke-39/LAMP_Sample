...
<body>
    <nav class="navbar navbar-dark bg-info">
      <div class="containar-flur">
        <div class="navbar-header">
            <a href="top.html" class="navbar-brand">LANP SAMPLE PAGE</a>
        </div>
      </div>
    </nav>
      ...
      <div class="tab-content">
        ...
        <form class="mt-3" action="./INSERT.php" method="POST">
            <div class="form-group row">
              ...
              <div class="col-sm-10"> 
                <input class="form-control" type="text" class="text" name="id" id="id">
              </div>
            </div>
            <div class="form-group row">
                <label for="name col-form-label">Name</label>
                <div class="col-sm-10">
                  <input class="form-control" type="text" class="text" name="name" id="name">
                </div>
              </div>
            <div class="form-group row">
                <label for="age col-form-label">Age </label>
                <div class="col-sm-10">
                  <input class="form-control" type="text" class="text" name="age" id="age">
                </div>
              </div>
        ...
        <div id="tab3" class="tab-pane"><h1>Sample3</h1></div>
        <div id="tab4" class="tab-pane"><h1>Sample4</h1></div>
      </div>
    </div>
